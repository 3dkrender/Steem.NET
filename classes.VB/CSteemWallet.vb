...
#Region "Public Methods"
    ...
    '''    broadcast: true if you wish to broadcast the transaction (type: bool)
    Public Function convert_sbd(from As String, amount As Decimal, Optional broadcast As Boolean = True) As JObject
        Dim arrParams As New ArrayList
        arrParams.Add(from)
    ...
    Public Function network_get_connected_peers() As JArray
        call_api_array(Reflection.MethodBase.GetCurrentMethod.Name)
    End Function
